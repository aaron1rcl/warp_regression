"""Compatibility wrappers: dual-sine fits via YAML WarpModel."""
...
from ..core.warp import soft_warp_numpy
from ..covariates.sine import build_dual_sines_from_fit, fit_dual_sine_log
...
def fit_dual_sine_shared_warp(
    ...
    return {
        **sine_fit,
        "z1": z1,
        "z2": z2,
        "z1_warped": soft_warp_numpy(z1, p, path_anchor=DEFAULT_PATH_ANCHOR),
        "z2_warped": soft_warp_numpy(z2, p, path_anchor=DEFAULT_PATH_ANCHOR),
        "y_hat_log": res.y_hat,
